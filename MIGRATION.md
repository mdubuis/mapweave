...
| 4 | Le wiki devient la coquille hôte ; carte intégrée (encore en SVG) ; arborescence live | Phase 2 | Moyen | Oui, au système d'ères et aux `map_ref` — voir plus bas | **En cours** (4.1 fait) |
...
### Phase 4 — Le wiki devient la coquille hôte ; arborescence live — **en cours**
